<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GenderSetup.aspx.cs" Inherits="Benetton.Settings.GenderSetup" %>
    ...
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="form_inner">
                <ul>
                    <li>
                        ...
                        <asp:TextBox runat="server" ID="txtGender" required="required"></asp:TextBox>
                    </li>
            ...
            <div class="clear">
                        ...
                        <asp:GridView runat="server" ID="gvGenderSetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvGenderSetup_OnRowDataBound" OnRowCommand="gvGenderSetup_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblGenderId" Text='<%#Bind("Id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
