<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SeasonSetup.aspx.cs" Inherits="Benetton.Settings.SeasonSetup" %>
    ...
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="form_inner">
                <ul>
                    <li>
                        ...
                        <asp:TextBox runat="server" ID="txtSeason" required="required"></asp:TextBox>
                    </li>
            ...
            <div class="clear">
                        ...
                        <asp:GridView runat="server" ID="gvSeasonSetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvSeasonSetup_OnRowDataBound" OnRowCommand="gvSeasonSetup_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblSeasonId" Text='<%#Bind("Id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Season">
                        <ItemTemplate>
                            <asp:Label ID="lblSeason" runat="server" Text='<%# Bind("Season") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
