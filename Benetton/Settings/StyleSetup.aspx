<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StyleSetup.aspx.cs" Inherits="Benetton.Settings.StyleSetup" %>
    ...
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="form_inner">
                <ul>
                    <li>
                        ...
                        <asp:TextBox runat="server" ID="txtStyle" required="required"></asp:TextBox>
                    </li>
                    <li>
                        <label>
                           Description
                        </label>
                        <asp:TextBox runat="server" ID="txtDescription" required="required"></asp:TextBox>
                    </li>
                </ul>
            </div>
            <div class="clear">
            ...
            <div class="clear">
              ...
              <asp:GridView runat="server" ID="gvStyleSetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvStyleSetup_OnRowDataBound" OnRowCommand="gvStyleSetup_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblStyleId" Text='<%#Bind("Id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
