<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ThemeCategorySetup.aspx.cs" Inherits="Benetton.Settings.ThemeCategorySetup" %>
    ...
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="clear">
               ...
               <asp:GridView runat="server" ID="gvThemeSetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvThemeSetup_OnRowDataBound" OnRowCommand="gvThemeSetup_RowCommand"
