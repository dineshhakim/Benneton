<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SizeSetup.aspx.cs" Inherits="Benetton.Settings.SizeSetup" %>
    ...
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="form_inner">
                <ul>
                    <li>
                        ...
                        <asp:TextBox runat="server" ID="txtSize" required="required"></asp:TextBox>
                    </li>
            ...
            <div class="clear">
                        ...
                        <asp:GridView runat="server" ID="gvSizeSetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvSizeSetup_OnRowDataBound" OnRowCommand="gvSizeSetup_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblSizeId" Text='<%#Bind("Id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
