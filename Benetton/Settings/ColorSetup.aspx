<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ColorSetup.aspx.cs" Inherits="Benetton.Settings.ColorSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="form_inner">
                <ul>
                    ...
                    <li>
                        ...
                        <asp:TextBox runat="server" ID="txtColorCode" required="required"></asp:TextBox>
                    </li>
                    <li>
                        <label>
                           Color Name
                        </label>
                        <asp:TextBox runat="server" ID="txtColorName" required="required"></asp:TextBox>
                    </li>
                </ul>
            </div>
            <div class="clear">
            ...
            <asp:GridView runat="server" ID="gvColorSetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvColorSetup_OnRowDataBound" OnRowCommand="gvColorSetup_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField Visible="False">
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lblColorId" Text='<%#Bind("Id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
