<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KnittingSubCategorySetup.aspx.cs" Inherits="Benetton.Settings.KnittingSubCategorySetup" %>
    ...
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="clear">
             ...
             <asp:GridView runat="server" ID="gvKnittingSubCategorySetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvKnittingSubCategorySetup_OnRowDataBound" OnRowCommand="gvKnittingSubCategorySetup_RowCommand"
