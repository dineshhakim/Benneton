<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="KnittingCategorySetup.aspx.cs" Inherits="Benetton.Settings.KnittingCategorySetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="updForm" runat="server">
        <ContentTemplate>
            ...
            <div class="form_inner">
                <ul>
                    <li>
                        ...
                        <asp:TextBox runat="server" ID="txtCategoryName" required="required"></asp:TextBox>
                    </li>
                </ul>
            </div>
            <div class="clear">
            ...
            <asp:GridView runat="server" ID="gvKnittingCategorySetup" ShowHeaderWhenEmpty="True" CssClass="table1"
                OnRowDataBound="gvKnittingCategorySetup_OnRowDataBound" OnRowCommand="gvKnittingCategorySetup_RowCommand"
