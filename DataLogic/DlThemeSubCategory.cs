...
namespace DataLogic
{
  public  class DlThemeSubCategory
    {
        public static string InsUpdDelThemeSubCategory(char Event, ThemeSetupSubCategory obj, out int returnId)
        {
            returnId = 0;
            try
            {
                ...
                cmd.CommandText = "USP_IUD_Theme_Sub_Category";
        ...
        public static DataTable GetThemeSUbCategory(int Event, int id, string code, string code1)
        {
            var cmd = new SqlCommand();
            ...
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "USP_SELECT_Theme_Sub_Category";
                cmd.Parameters.AddWithValue("@EVENT", Event);
