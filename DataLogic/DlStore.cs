...
namespace DataLogic
{
    ...
    {
        public static string InsUpdDelStore(char Event, Store obj, out int returnId)
        {
            returnId = 0;
            try
            {
                ...
                cmd.CommandText = "USP_IUD_tbl_Store";
                cmd.Connection = DL_CCommon.ConnectionForCommonDb();
                cmd.Parameters.AddWithValue("@EVENT", Event);
                cmd.Parameters.AddWithValue("@ID", obj.Id);
                cmd.Parameters.AddWithValue("@Store_No", obj.StoreNo);
                cmd.Parameters.AddWithValue("@Store_Name", obj.StoreName);
        ...
        public static DataTable GetStoreDetail(int Event, int id, string code, string code1)
        {
            var cmd = new SqlCommand();
            ...
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "USP_SELECT_STORE";
                cmd.Parameters.AddWithValue("@EVENT", Event);
